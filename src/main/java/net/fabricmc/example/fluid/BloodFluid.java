...
public class BloodFluid extends AbstractFluid {
    ...
    public Fluid getFlowing() {
        return MoreFluidsMod.FLOWING_BLOOD;
    }

    @Override
    public Fluid getStill() {
        return MoreFluidsMod.STILL_BLOOD;
    }
    ...
    protected BlockState toBlockState(FluidState state) {
        return MoreFluidsMod.BLOOD.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
